...
class Food:
    def __init__(self):
        ...
        canvas.create_arc(x, y, x + SPACE_SIZE, y + SPACE_SIZE, fill=FOOD_COLOUR, tag="food")
...
def next_turn(snake, food):
    ...
    square = canvas.create_oval(x, y, x + SPACE_SIZE, y + SPACE_SIZE, fill=SNAKE_COLOUR)
